...
public class PropertiesBuilderImpl implements PropertiesBuilder {
    ...
    private static final Logger logger = Logger.getLogger(PropertiesBuilderImpl.class.getName());
    ...
    private boolean buildResultValid;
    ...
    public Properties build() throws IOException {
        ...
        this.buildResultValid = false;
        
        this.updateCount = 0;
        
        this.validationAttempts = 0;
        
        while(!(buildResultValid = validator.test(props)) && validationAttempts++ < maxTrials) {
        ...
        if(buildResultValid && updateCount > 0) {
    ...
    public Properties load(Map defaultValues) throws IOException {
        ...
        logger.log(Level.FINE, "Loading properties from: {0}", sourceFile);
        try{
    ...
    public int updateWithValuesFromUserPrompt(Properties props) {
        ...
        logger.fine(() -> "Updated " + atomicUpdateCount.intValue() + " properties. Update: " + props);
...
//////////////////////////// Getters ////////////////////////////////    
    ...
    @Override
    public boolean isBuildResultValid() {
        return buildResultValid;
    }
