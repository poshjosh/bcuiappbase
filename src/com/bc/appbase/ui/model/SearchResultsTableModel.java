...
public class SearchResultsTableModel<T> extends EntityTableModel {
    ...
    public SearchResultsTableModel(App app, SearchResults<T> searchResults, ResultModel<T> resultModel) {
        this(app, searchResults, resultModel, 0, searchResults.getPageCount());
    }
    
    public SearchResultsTableModel(App app, SearchResults<T> searchResults, 
