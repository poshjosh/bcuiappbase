...
public abstract class AuthenticationAction implements Action<App, User> {
    ...
    public User execute(App app, Map<String, Object> params) 
        ...
        try{
            ...
            final AppAuthenticationSession authSess = app.getAuthenticationSession();
            
            if(authSess == null) {
                throw new TaskExecutionException("Authentication not Supported");
            }
    ...
    public abstract void doExecute(App app, Map params) throws LoginException;
}
