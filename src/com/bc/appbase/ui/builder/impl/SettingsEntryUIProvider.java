 ...
 */
public class SettingsEntryUIProvider extends EntryUIProviderImpl {

    private final Settings settings;

    public SettingsEntryUIProvider(App app) {
        super(app);
        this.settings = app.getSettings();
    }

    public SettingsEntryUIProvider(Settings settings, ComponentModel cm, int labelWidth) {
        super(cm, labelWidth);
