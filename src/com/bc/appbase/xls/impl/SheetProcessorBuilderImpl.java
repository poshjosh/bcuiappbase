...
public class SheetProcessorBuilderImpl<R> implements SheetProcessorBuilder<R> {
        ...
        if(this.rowProcessor == null) {
            ...
            if(this.metaData == null) {
                ...
                if(this.typeProvider == null) {
                    this.typeProvider = this.createTypeProvider(this.app);
                }
            ...
            if(this.cellProcessorFactory == null) {
                ...
                if(this.textHandler == null) {
                    this.textHandler = this.createTextHandler(this.app);
                }
    ...
    public TypeProvider createTypeProvider(App app) {
        return app.getOrException(TypeProvider.class);
    }
    
    public TextHandler createTextHandler(App app) {
        return app.getOrException(TextHandler.class);
    }
    ...
    @Override
    public SheetProcessorBuilder<R> app(App app) {
        this.app = app;
        return this;
    }
