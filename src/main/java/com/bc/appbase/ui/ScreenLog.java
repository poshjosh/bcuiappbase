...
public class ScreenLog implements ProcessLog {
    ...
    private transient static final Logger LOG = Logger.getLogger(ScreenLog.class.getName());
    ...
    private volatile long lastDisplayTime;
    @Override
    public void log(String msg) {
        ...
        if(messageBuffer != null) {
            ...
            if((System.currentTimeMillis() - lastDisplayTime) > 1_500) {
                ...
                if(EventQueue.isDispatchThread()) {
                    ...
                    EventQueue.invokeLater(() -> {
                        try{
                            ...
                            LOG.log(Level.WARNING, "Error logging message.", e);
                        }
                    });
                }
            }
