...
public class RefreshAllResults extends RefreshResults implements Action<App, Object> {
    ...
    private transient static final Logger LOG = Logger.getLogger(RefreshAllResults.class.getName());
    ...
    public Object execute(final App app, final Map<String, Object> params) 
        ...
        LOG.log(Level.FINE, "Refreshing {0} search results UI", uiList.size());
