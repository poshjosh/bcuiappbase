...
public interface MatchEntries {
    ...
    default MatchEntries app(App app) {
        this.objectFactory(app);
        this.uiContext(app.getUIContext());
        return this;
    }

    MatchEntries objectFactory(ObjectFactory objectFactory);
    
    MatchEntries uiContext(UIContext uiContext);
