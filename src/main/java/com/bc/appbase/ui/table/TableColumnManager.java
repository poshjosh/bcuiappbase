	...
	implements MouseListener, ActionListener, TableColumnModelListener, PropertyChangeListener
{
	...
	public void setMenuPopup(boolean menuPopup)
	{
        ...
        public void setVisible(int modelColumn, boolean visible) {
          
            if(visible) {
                
                this.showColumn(modelColumn);
                
            }else{
                
                this.hideColumn(modelColumn);
            }
        }

        public void setVisible(Object columnName, boolean visible) {
        ...
        public void setVisible(TableColumn columnName, boolean visible) {
	...
	private void showColumn(TableColumn column)
	{
		...
		tcm.removeColumnModelListener( this );
                ...
                if(!this.modelContains(tcm, column)) {
        ...
        public boolean modelContains(TableColumnModel columnModel, TableColumn column) {
            
            final int columnCount = columnModel.getColumnCount();
            
            final Object targetIdentifier = column.getIdentifier();
            
            for(int columnIndex=0; columnIndex<columnCount; columnIndex++) {
             
                if(Objects.equals(targetIdentifier, columnModel.getColumn(columnIndex).getIdentifier())) {
