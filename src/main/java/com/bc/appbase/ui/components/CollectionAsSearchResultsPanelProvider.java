...
public class CollectionAsSearchResultsPanelProvider extends AbstractCollectionComponentProvider {
    ...
    public CollectionAsSearchResultsPanelProvider(
            App app, ComponentModel.ComponentProperties props, int batchSize) {
    ...
    public Component execute(Class parentType, Class valueType, String name, Collection value) {
        ...
        panel.load(app.getSearchContext(collectionValueType), searchResults, null);
        ...
        app.getUIContext().updateTableUI(table, collectionValueType, serialColumnIndex);
