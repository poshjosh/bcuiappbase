...
public abstract class AbstractCollectionComponentProvider implements CollectionComponentProvider {
    ...
    public AbstractCollectionComponentProvider(ObjectFactory objectFactory, ComponentModel.ComponentProperties props, int batchSize) {
    ...
    public List toEntitiesList(Collection values, Class valueType) {
        ...
        final EntityStructureFactory esf = objectFactory.getOrException(EntityStructureFactory.class);
