...
public class SelectFileThenWorksheetPromptImpl implements SelectFileThenWorksheetPrompt {
    ...
    public SelectFileThenWorksheetPromptImpl() { }
    
    @Override
    public Sheet execute(AppCore appCore, Sheet outputIfNone) {
        
        try{
            
            final File file = this.promptSelectExcelFile(appCore);
            ...
            final String sheetName = this.promptSelectSheetName(appCore, workbook);
    ...
    @Override
    public File promptSelectExcelFile(AppCore app) throws ParameterException, TaskExecutionException {
